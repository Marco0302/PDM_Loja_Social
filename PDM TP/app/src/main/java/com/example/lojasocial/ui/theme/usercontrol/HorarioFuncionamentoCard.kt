...
@Composable
fun HorarioFuncionamentoCard(id:String, data: String, numeroMaxVoluntarios: String, vagasDisponiveis: String, onClick: () -> Unit) {
...
fun PreviewHorarioFuncionamento() {
    HorarioFuncionamentoCard("0", data = "2025-01-17", numeroMaxVoluntarios = "8", vagasDisponiveis = "10", onClick = {})
}